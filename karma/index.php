...
<head>
    ...
    <script type="text/javascript">
		...
		"use strict";
			...
			function phantrang(page,sale){
				$.ajax({
					type:"get",
					url:"phantrang1.php",
					data:{page:page,sale:sale},
					success:function(data){
						$('#products').html(data);
					}
				});
						...
						<!-- single-slide -->
							<div class="col-lg-5 col-md-6">
								<div class="banner-content">
									<h1>Happiness</h1><br><h3 style="margin-left:20">begins simply with just a pair of shoes</h3>
								</div>
							</div>
				</div>
			</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-deal">
						...
						<img class="img-fluid w-100" src="img/category/c5.jpg" alt="">
							<div class="deal-details" id="animate">
								<a><h6 class="deal-title">Exclusive Hot Deal</h6></a>
							</div>
					</div>
				</div>
			</div>
