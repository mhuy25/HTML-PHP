				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
					  ...
					  ?>
							...
							<li class="nav-item active"><a href="cart.php" class="cart"><span class="ti-bag"></span>
	...
	require("connect.php");
			...
			?>							
                            <tr class="bottom_button">
                                <td></td><td></td><td></td><td><a class="gray_btn" onClick="window.location.reload(true)" href="#">Update Cart</a></td>
								<td></td><td></td>
                            </tr>
                            <tr>
                                <td></td><td></td><td></td>
                                <td><font color="#FF0004">Total:</font></td>
                                <td>
                            ...
                            <tr class="out_button_area">
                                <td><h3>*Remember to sign in to checkout</h3></td><td></td><td></td><td></td>
                                <td>
                                    <div class="checkout_btn_inner d-flex align-items-center">
                                        <a class="gray_btn" href="category.php">Continue Shopping</a>
                                        <a class="primary-btn" onclick="checkCart()">Proceed to checkout</a>
                                    </div>
                                </td><td></td>
                            </tr>
                        </tbody>						
