            ...
            <div class="menu">
                <ul class="list">
					...
					<li class="active">
                        ...
                        <ul class="ml-menu">
                            <li class="active">
                                <a href="pages/tables/product-table.php">Products Table</a>
                            </li>
                            <li>
                                <a href="pages/tables/jquery-datatable.html">Order statistics</a>
                            </li>
                            <li>
                                <a href="pages/tables/editable-table.html">Orders Table</a>
                            </li>
                        </ul>
                    </li>
<!--
                                ...
                                <table id="products" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										...
										while($row=mysqli_fetch_assoc($results)){
											$str.='<tr id="'.$row["ProductID"].'" data-toggle="modal" data-target="#myModal">';
											$str.="<td>".$row['ID']."</td>";
