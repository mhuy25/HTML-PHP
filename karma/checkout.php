			...
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
					  ...
					  if(isset($_SESSION['isLogin'])){
						  if($_SESSION['isLogin']==1){
							  echo '<span><a href="#" id="name"> Hello, '.$_SESSION['nameLogin'].'</a></span>';
						  }
					  }
					  ?>
					  </li>
                ...
                <textarea name="c_order_notes" id="c_order_notes" cols="30" rows="5" class="form-control" placeholder="Write your notes here..."></textarea>
                        ...
                        <div class="order_box">
                            ...
                            <ul class="list list_2">
                                <li><a>Total <span>$<?php echo($total); $_SESSION['cart']['total']=$total; ?></span></a></li>
                            </ul>
                        </div>
													<div class="form-group">
                    			<button type="submit" class="btn btn-primary btn-lg py-3 btn-block mt-3">Place Order</button>
                  			</div>	
                    </div>
        </div>
	</form>
